      ...
      <header id="navbar-sticky" className="navbar">
        <div className="container">
          <nav>
            ...
            <div
              className="hs-collapse mx-auto
              mt-2 hidden grow basis-full
              items-center justify-center transition-all duration-300 lg:mt-0 lg:flex lg:basis-auto"
              id="mobileMenu"
            >
              <ul id="navbar-navlists" className="navbar-nav">
                {menu.map((list, index) => (
