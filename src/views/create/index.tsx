...
export const CreateView: FC<CreateViewProps> = ({ setOpenCreateModal }) => {
  ...
  const isClick = Object.values(token).every(
    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: "579de9447352d26b96ae",
            pinata_secret_api_key:
              "044a723f3dc482e9eea02ff05e44e1de5a718890d1b096b89ae6ef14a1cb5cc9",
                      ...
                      <div className="mb-6 text-center">
                        <button
                          ...
                          className={`bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full items-center justify-center rounded-lg px-6 py-2 text-white backdrop-blur-2xl transition-all duration-500 ${
                            !isClick ? "cursor-not-allowed" : "cursor-pointer"
                          }`}
                          type="submit"
                        >
