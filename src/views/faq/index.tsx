        ...
        <div className="mx-auto max-w-3xl">
          <div className="hs-accordion-group space-y-4">
            {questions.map((question, index) => (
              <div
                key={index}
                className={`hs-accordion bd-default-950/40 overflow-hidden rounded-lg bordder border-white/10 backdrop-blur-3xl`}
                id={question.id}
              >
                <button
                  className="hs-accordion-toggle inline-flex items-center justify-between gap-x-3 px-6 py-4 text-left capitalize text-white tansition-all"
                ...
                <div
                  id={`faq-accordio-${index + 1}`}
                  className="hs-accordion-content w-full overflow-hidden trasition-[height] duration-300"
                ...
                >
                  <div className="px-6 pb-4 pt-0">
                    ...
                    <p className="text-default-300 text-sm font-medium">
                      ...
                      Something we should write here
                    </p>
                  </div>
                </div>
              </div>
