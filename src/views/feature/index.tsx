...
export const FeatureView: FC<ToolViewProps> = ({
  setOpenAirdrop,
  setOpenContact,
  setOpenCreateModal,
  ...
  const features = [
    {
      ...
      description:
        "Start working with solana token creator, It allow you to create dolana token by creating and deploying , airdrop, transfering and updating token ",
  ...
  return (
    <section className="py-20" id="feautures">
        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-default-200 text-sm font-medium">
              {" "}
              Now you can create Solana Toekn <br />
              to without code instanly
            </p>
          </div>
        </div>
            ...
            >
              <div className="p-8 sm:p-10">
                <div className="bg-primary/10 text-primary mb-10 inline-flex h-16 w-16 items-center justify-center rounded-xl">
                  <i data-lucide="farmer">{list.icon}</i>
                </div>
                ...
                <a
                  ...
                  className="hover:bg-primary inline-flex items-center justify-center gap-2 rounded-full bordder border-white/10 px-6 py-2 text-white transition-all duration-200"
                >
                  Use Tools
                  <i>
