        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-default-200 text-sm font-medium">
              ...
              natus aspernatur alias provident pariatur sint ducimus laudantium,{" "}
              <br />
              velit repellat esse.
            </p>
          </div>
            ...
            <div className="bg-default-950/40 hover:-translate-y-2 border-primary border-s-2 rounded-xl backdrop-blur-3xl transition-all duration-500">
              <div className="p-10">
                ...
                <p className="text-default-100 mb-4 text-sm font-medium">
                  ...
                  Culpa earum corrupti molestias sit nisi eveniet possimus ipsa
                  aspernatur unde eum distinctio reiciendis provident, quibusdam
                  dolores ea pariatur ratione sed, numquam doloremque! Sapiente,
                  tenetur modi!
                </p>
                <a
                  href=""
